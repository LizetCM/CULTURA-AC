...
export function ContactPanel({ className }: ContactPanelProps) {
  return (
    <div className={cn("grid gap-10 lg:grid-cols-5", className)}>
      <div className="text-center text-sm text-zinc-600 dark:text-zinc-400 lg:col-span-2 lg:text-left">
        <p className="font-semibold text-zinc-900 dark:text-zinc-50">Datos</p>
