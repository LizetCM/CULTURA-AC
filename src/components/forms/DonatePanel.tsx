  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-zinc-200 bg-surface-muted p-6 text-sm leading-relaxed text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400">
        ...
        <p className="mt-2">
          Publicamos informes de avance. Las donaciones se aplican a programas
          culturales priorizados por la asamblea y el consejo directivo. Si
          necesitas factura o comprobante fiscal, indícalo en tu mensaje.
        </p>
      </div>
    </div>
  );
